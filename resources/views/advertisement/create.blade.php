   ...
   <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-12 col-lg-4">
                ...
                <div class="card-body">
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="{{__('advertisement/create.enter_title')}}" value="{{old('title')}}">
                    @error('title')
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="card-body">
                    <input type="date" name="valid_date" class="form-control @error('valid_date') is-invalid @enderror" placeholder="{{__('advertisement/create.enter_date')}}" value="{{old('valid_date')}}">
                    @error('valid_date')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="card-body">
                    <textarea type="text" name="description" class="form-control @error('description') is-invalid @enderror" placeholder="{{__('advertisement/create.enter_description')}}" value="{{old('description')}}"></textarea>
                    @error('description')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
