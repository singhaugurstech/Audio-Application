   ...
   <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-12 col-lg-4">
                ...
                <div class="card-body">
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{$contact->title}}">
            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="card-body">
                    <textarea type="text" name="description" class="form-control @error('description') is-invalid @enderror" placeholder="Enter Description">{{$contact->description}}</textarea>
                    @error('description')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
